...
import { useButtonProps, type ButtonProps as BaseButtonProps } from '@restart/ui/Button';
...
const Button: DynamicRefForwardingComponent<'button', ButtonProps> = React.forwardRef<
  HTMLButtonElement,
  ButtonProps
>(
  (
