...
import type { DropDirection } from './DropdownContext.ts';
...
export interface BaseOverlayProps extends TransitionCallbacks {
  /**
   * Enables the Popper `flip` modifier, allowing the Overlay to
   * automatically adjust it's placement in case of overlap with the viewport or toggle.
   * Refer to the [flip docs](https://popper.org/popper-documentation.html#modifiers..flip.enabled) for more info
   */
  ...
  /**
   * A DOM Element, [Virtual Element](https://popper.org/docs/v2/virtual-elements/), Ref to an element, or
