...
export interface DropdownButtonProps
  extends BsDropdownProps,
    PropsFromToggle,
    Omit<React.HTMLAttributes<HTMLElement>, 'onSelect' | 'children' | 'onToggle' | 'title'> {
  /**
   ...
   * Popper's flip [docs](https://popper.org/docs/v2/modifiers/flip/).
   */
 ...
 */
const DropdownButton: DynamicRefForwardingComponent<'div', DropdownButtonProps> = React.forwardRef<
  HTMLDivElement,
  DropdownButtonProps
>(
  (
