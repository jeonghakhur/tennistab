...
const DropdownDivider: DynamicRefForwardingComponent<'hr', DropdownDividerProps> = React.forwardRef<
  HTMLElement,
  DropdownDividerProps
>(({ className, bsPrefix, as: Component = 'hr', role = 'separator', ...props }, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, 'dropdown-divider');
  return <Component ref={ref} className={clsx(className, bsPrefix)} role={role} {...props} />;
});
