...
const FloatingLabel: DynamicRefForwardingComponent<'div', FloatingLabelProps> = React.forwardRef<
  HTMLElement,
  FloatingLabelProps
>(({ bsPrefix, className, children, controlId, label, ...props }, ref) => {
  ...
  return (
    <FormGroup ref={ref} className={clsx(className, bsPrefix)} controlId={controlId} {...props}>
      {children}
